! function(t, e) {
    ...
    o = {
        ...
        _create: function() {
            if (t.support.iris) {
                var e = [];
                for (var o in drupalSettings.glazedBuilder.palette) e.push(drupalSettings.glazedBuilder.palette[o]);
                var a = this,
                    s = a.element;
                ...
                }).attr("title", wpColorPickerL10n.pick).attr("data-current", wpColorPickerL10n.current), a.pickerContainer = t(r).insertAfter(s), a.button = t(l), a.options.defaultColor ? a.button.addClass("wp-picker-default").val(wpColorPickerL10n.defaultString) : a.button.addClass("wp-picker-clear").val(wpColorPickerL10n.clear), s.wrap('<span class="wp-picker-input-wrap" />').after(a.button), s.iris({
